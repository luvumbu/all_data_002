...
for(var r = 0 ; r<get_epreuve_nom_complet.length; r++){
  if(get_epreuve_nom_complet[r]=="S"){
    get_emplacement = "SALLE" ; 
  }
  else {
    get_emplacement = "PLEIN AIR" ; 
...
var ok_ = new Information("https://bokonzi.com/all_data/array_scrypt/php_3.php"); // création de la classe 
...
ok_.add("get_emplacement", get_emplacement); // ajout de l'information pour lenvoi 
