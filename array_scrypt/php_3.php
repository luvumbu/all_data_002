...
$get_users_nom_complet_array_xx = new Fruit();
$get_users_nom_complet_array_xx->set_my_string($get_users_nom_complet_array) ; 
 
 
$get_users_nom_complet_array_xx->recherche_dans_string() ;
$get_users_nom_complet_array_xx->replace_all() ;

$valx =$get_users_nom_complet_array_xx->my_array_x[0];
...
for($i=1;$i<count($get_result_users_nom_1_array_2_xx->my_array_x);$i++){
  ...
  $valx =$get_users_nom_complet_array_xx->my_array_x[$i];
